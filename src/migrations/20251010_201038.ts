...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_header_nav_items_sublinks_link_type" AS ENUM('reference', 'custom');
  ...
  CREATE TABLE IF NOT EXISTS "header_nav_items_sublinks" (
  	"_order" integer NOT NULL,
  	"_parent_id" varchar NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"link_type" "enum_header_nav_items_sublinks_link_type" DEFAULT 'reference',
  	"link_new_tab" boolean,
  	"link_url" varchar,
  ...
  DO $$ BEGIN
   ALTER TABLE "header_nav_items_sublinks" ADD CONSTRAINT "header_nav_items_sublinks_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."header_nav_items"("id") ON DELETE cascade ON UPDATE no action;
  EXCEPTION
   WHEN duplicate_object THEN null;
  END $$;
  ...
  CREATE INDEX IF NOT EXISTS "header_nav_items_sublinks_order_idx" ON "header_nav_items_sublinks" USING btree ("_order");
  CREATE INDEX IF NOT EXISTS "header_nav_items_sublinks_parent_id_idx" ON "header_nav_items_sublinks" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "header_nav_items_sublinks" CASCADE;
  ...
  DROP TYPE "public"."enum_header_nav_items_sublinks_link_type";
