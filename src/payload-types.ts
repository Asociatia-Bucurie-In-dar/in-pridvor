...
export interface Config {
  ...
  jobs: {
    tasks: {
      revalidateCache: TaskRevalidateCache;
...
export interface Page {
  ...
  /**
   * Optional. Any field left empty falls back to the Romanian source.
   */
  en?: {
    /**
     * Leave empty to fall back to Romanian
     */
    title?: string | null;
    hero?: {
      richText?: {
...
export interface PayloadJob {
  ...
  log?:
    | {
        executedAt: string;
        completedAt: string;
        taskSlug: 'inline' | 'revalidateCache' | 'schedulePublish';
        taskID: string;
        input?:
          | {
              [k: string]: unknown;
    ...
    | null;
  taskSlug?: ('inline' | 'revalidateCache' | 'schedulePublish') | null;
  queue?: string | null;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "TaskRevalidateCache".
 */
